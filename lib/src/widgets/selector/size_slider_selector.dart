...
class _SizeSliderWidgetState extends State<SizeSliderWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer3<TextEditorProvider, ControlVariableProvider, PaintingProvider>(
      builder: (context, editorProvider, controlProvider, paintingProvider, child){
        return Stack(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Slider(
                        value: controlProvider.isPainting
                            ? paintingProvider.lineWidth : editorProvider.textSize,
                        min: controlProvider.isPainting ? 5 : 14,
                        max: controlProvider.isPainting ? 20 : 50,
                        activeColor: Colors.transparent,
                        thumbColor: Colors.white,
                        inactiveColor: Colors.transparent,
                        onChanged: (value){
                          if(controlProvider.isPainting){
                            paintingProvider.lineWidth = value;
                          } else{
                            editorProvider.textSize = value;
                          }
                        },
                        onChangeStart: (start){
                          setState(() {
